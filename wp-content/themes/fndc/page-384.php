...
<div id="bigcarousel" style="background-image:url(http://fundacion.upmedia.cl/wp-content/uploads/2014/07/slide1.jpg)">
	<div class="container">
		<div class="row">
...
<div id="insidemenu" class="clr-somos" style="margin-top:-45px;">
	<div class="container">
		<div class="row">			
			<?php $menu = get_field('menu_inside_selector')?>
			<?php wp_nav_menu( array('menu' => 'Noticias' , 'container' => 'none' , 'menu_id' =>  'noticias' , 'menu_class' => 'menu-insider desktop'));?>
		</div>
	</div>
</div>


<div id="undermain" style="margin-top: 0px;">
	...
	<div class="container">
		...
		<div class="col-md-8">
			...
			<?php $noticias = query_posts(array('numberposts' => '10', 'post_type' => 'post' , 'paged'=> $paged))?>
			<?php $count = 1;?>
			<?php foreach ($noticias as $noticia):?>
			
				<div class="mini-noticia noticia <?php if($count % 2 == 0 ){echo 'nomargin';}?>">
