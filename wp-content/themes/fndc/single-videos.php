...
<div id="undermain">
	<div class="container">
		<div class="row">
			...
			<div class="superimage"><iframe src="//player.vimeo.com/video/<?php echo get_field('video_id')?>" width="100%" height="580" frameborder="0" portrait="0" color="ed8484" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div>
