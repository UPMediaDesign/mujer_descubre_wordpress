					...
					<div class="timeliner">
						<div class="hits">
							<ul>
								...
								?>
									<li id="hitt-<?php echo $hitocounter?>" class="pointss <?php if($hitocounter==1){echo 'activex';}?>" style="left:<?php echo $posicion; //if($totalhitos == $hitocounter){echo $hitoposition-1;}else{echo $hitoposition;}?>%" data-toggle="tooltip" data-placement="bottom" title="<?php echo $hito['hito']?>"><?php if($hito['mostrar']){?><span><?php echo $date->format('Y');?></span><?php }?></li>
