...
return 'http://mujer.upmedia.cl';
}
// CUSTOM ADMIN LOGIN HEADER LOGO
function my_custom_login_logo() {
    echo '<style type="text/css">
	body.login{
		background-color:#ea4382 !important;
...
border-radius: 4px 4px 4px 4px;
	...
	.login #nav a:hover, .login #backtoblog a:hover{
        ...
        .login h1 a { background-image:url('.get_bloginfo('template_directory').'/images/mujerlogo.png) !important;
